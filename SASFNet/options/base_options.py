...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--which_model_netG', type=str, default='single_stage', help='selects model to use for netG')
		...
		self.parser.add_argument('--name', type=str, default='SESFNet', help='name of the experiment. It decides where to store samples and models')
		self.parser.add_argument('--dataset_mode', type=str, default='Gopro', help='chooses how datasets are loaded. [unaligned | aligned | single]')
